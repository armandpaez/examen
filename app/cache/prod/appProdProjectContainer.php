...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'admin123', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8af4cd9d96c3347353f5da83e3edbdfe72eb055413f6a20f9c500cea25817441');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Examen/HolaBundle/Resources/views'), 'ExamenHola');
        $instance->addPath(($this->targetDirs[3].'/src/Examen/SorterBundle/Resources/views'), 'ExamenSorter');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0111104f8061bbe83f1c810af5130b10a68');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('560ef45e23dd42.41136725')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ExamenHolaBundle' => 'Examen\\HolaBundle\\ExamenHolaBundle',
                'ExamenSorterBundle' => 'Examen\\SorterBundle\\ExamenSorterBundle',
            ),
            ...
            'secret' => '0111104f8061bbe83f1c810af5130b10a68',
            'locale' => 'en',
            ...
            'kernel.secret' => '0111104f8061bbe83f1c810af5130b10a68',
